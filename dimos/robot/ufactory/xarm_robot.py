...
from dimos.hardware.ufactory import XArmModule
...
logger = setup_logger("dimos.robot.ufactory.xarm")


class XArmRobot(Robot):
    """xArm robot with ZED camera, detection, and manipulation capabilities."""
    ...
    def start(self):
        ...
        self.stereo_camera = self.dimos.deploy(
            ...
            depth_mode="NEURAL",
            fps=30,
            enable_tracking=False,  # Disable tracking - using xarm transforms
            publish_rate=30.0,
        ...
        # Deploy xArm module
        logger.info("Deploying xArm module...")
        self.xarm = self.dimos.deploy(
            XArmModule,
            arm_ip=self.arm_ip,
        ...
        logger.info("XArmRobot initialized and started with modular architecture")
    ...
    def stop(self):
        ...
        logger.info("Stopping XArmRobot...")
