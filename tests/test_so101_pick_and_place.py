...
"""
Run script for SO101 Arm robot with pick and place functionality.
Subscribes to visualization images and handles mouse/keyboard input.
Uses webcam instead of ZED camera.
"""
...
logger = setup_logger("dimos.tests.test_so101_pick_and_place")
...
class VisualizationNode:
    ...
    def __init__(self, robot: SO101ArmRobot):
        self.lcm = LCM()
...
async def run_so101_arm_with_viz():
    """Run the SO101 Arm robot with visualization."""
